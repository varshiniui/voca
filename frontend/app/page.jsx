...
const DEMO_NOTES = [
  {
    transcription: "Attended the machine learning lecture today. The professor went really deep into backpropagation and how gradient descent works. Then we moved on to convolutional neural networks — covered convolution, pooling, and activation functions. The exam is next Thursday and neural networks is the main topic. I also need to finish the linear regression assignment before Friday.",
    ...
    keyPoints: ["Backpropagation and gradient descent covered in depth", "CNNs introduced — convolution, pooling, activation functions", "Exam is next Thursday — neural networks is the main topic"],
    actionItems: ["Revise gradient descent notes by Wednesday", "Complete linear regression assignment", "Watch 3Blue1Brown CNN explainer video", "Form study group with Priya and Arjun"],
    mood: "Focused", wordCount: 54,
  },
  {
    transcription: "Quick planning session for the Voca mobile app. We decided to go with React Native over Flutter because the whole team already knows JavaScript so iteration will be faster. The three core screens we need are the recorder, the summary view, and the history panel. We are targeting a working prototype in two weeks because I want to demo it during my internship presentation.",
    ...
    keyPoints: ["React Native chosen over Flutter — JS familiarity wins", "Three core screens: Recorder, Summary, History", "Two-week timeline targeting internship demo day"],
    actionItems: ["Set up React Native project with Expo", "Wire up existing backend API to mobile", "Design low-fi mockups for all three screens", "Test audio recording on both iOS and Android"],
    mood: "Professional", wordCount: 61,
  },
  {
    transcription: "Okay lots to sort out this weekend. I need to renew my driving licence before it expires on the 15th, that is urgent. Also need to pick up my prescription from the pharmacy and call the landlord about that leaking tap in the bathroom. Oh and I really want to find time to catch up with Meera, we haven't spoken in weeks and I keep forgetting to text her.",
    ...
    keyPoints: ["Driving licence expires on the 15th — urgent", "Prescription ready at pharmacy for pickup", "Landlord needs to be contacted about the tap"],
    actionItems: ["Book driving licence renewal appointment online", "Pick up prescription from pharmacy before 6pm", "Call landlord and report the leaking tap", "Text Meera and plan a catch-up call"],
